...
public class ContentProviderBase
{
  ...
  protected final String TEXT_5 = ".data.helper.AplicacaoDbHelper;" + NL + "import android.content.ContentValues;" + NL + "import android.content.ContentResolver;" + NL + "import android.content.UriMatcher;" + NL + "import android.database.Cursor;" + NL + "import android.database.sqlite.SQLiteDatabase;" + NL + "import android.database.sqlite.SQLiteQueryBuilder;" + NL + "import android.database.SQLException;" + NL + "import android.database.DatabaseUtils;" + NL + "import android.net.Uri;" + NL + "import ";
  ...
  protected final String TEXT_133 = "\");" + NL + "\t\t\t\tDCLog.d(DCLog.TRACE_LISTA,this,\"chamar query";
  protected final String TEXT_134 = "()\");" + NL + "\t\t\t\t//retCursor = query";
  protected final String TEXT_135 = "(uri,projection,sortOrder);" + NL + "\t\t\t\tString param = uri.getQuery();" + NL + "\t\t\t\tString sql = query";
  protected final String TEXT_136 = "(param) + (sortOrder!=null?\" order by \" + sortOrder:\"\");" + NL + "\t\t\t\tDCLog.d(DCLog.TRACE_LISTA,this,\"SQL: \" + sql);" + NL + "\t\t\t\tretCursor = this.queryRaw(sql);" + NL + "\t\t\t\tDCLog.d(DCLog.TRACE_LISTA,this,\"Cursor: \" + retCursor.getCount() + \" linhas\");" + NL + "\t\t\t\tbreak;" + NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_137 = NL + "\t\t}\t" + NL + "        return retCursor;" + NL + "\t}" + NL + "\t" + NL + "\tprivate String sqlWhere(Uri uri) {" + NL + "\t\tString sql = \" where \";" + NL + "\t\t// SemChaveEstrangeira - Sem Usuario (sempre vai ser o mesmo, redundante)" + NL + "  \t";
  protected final String TEXT_138 = NL + "\t\tif (existeItem(\"Sem";
  protected final String TEXT_139 = "\",uri.getPathSegments())) {" + NL + "\t\t\tsql += ";
  protected final String TEXT_140 = "Contract.COLUNA_CHAVE + \" not in (select \" + " + NL + "\t\t\t\t\t";
  protected final String TEXT_141 = "Contract.COLUNA_";
  protected final String TEXT_142 = " + \" from \" +" + NL + "\t\t\t\t\t";
  protected final String TEXT_143 = "Contract.TABLE_NAME + \")\";" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_144 = NL + "\t\t" + NL + "\t\treturn sql;" + NL + "\t}" + NL + "\t" + NL + "\tprivate String sqlSelect(Uri uri) {" + NL + "\t\tString sql = ";
  protected final String TEXT_145 = "Contract.camposOrdenados();" + NL + "\t\tList<String> segmentos = uri.getPathSegments();" + NL + "\t\t// ComChaveEstrangeira - Sem Usuario (sempre vai ser o mesmo, redundante)" + NL + "  \t";
  protected final String TEXT_146 = NL + "\t\tif (existeItem(\"Com";
  protected final String TEXT_147 = "\",uri.getPathSegments())) {" + NL + "\t\t\tsql += \",\" +  ";
  protected final String TEXT_148 = "Contract.camposOrdenados();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_149 = NL + "\t" + NL + "\t// SemChaveEstrangeira - Sem Usuario (sempre vai ser o mesmo, redundante)" + NL + "  \t";
  protected final String TEXT_150 = NL + "\t\tif (existeItem(\"Com";
  protected final String TEXT_151 = "\",uri.getPathSegments())) {" + NL + "\t\t\tsql += \",\" +  ";
  protected final String TEXT_152 = "Contract.camposOrdenados();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_153 = NL + "\t\t" + NL + "\t\t" + NL + "\t\t" + NL + "\t\treturn sql;" + NL + "\t}" + NL + "\tprivate String sqlFrom(Uri uri) {" + NL + "\t\tString sql = ";
  protected final String TEXT_154 = "Contract.TABLE_NAME;" + NL + "\t\tList<String> segmentos = uri.getPathSegments();" + NL + "\t\t//if (existeItem(\"ComEpisodioReferenteA\",uri.getPathSegments())) {" + NL + "\t\t//\tsql += \" \" +  EpisodioUsuarioContract.innerJoinEpisodio_ReferenteA();" + NL + "\t\t//}" + NL + "\t\t" + NL + "\t\t" + NL + "\t\t\t\t// ComChaveEstrangeira" + NL + "  \t";
  protected final String TEXT_155 = NL + "\t\tif (existeItem(\"Com";
  protected final String TEXT_156 = "\",uri.getPathSegments())) {" + NL + "\t\t\tsql += \" \" +  ";
  protected final String TEXT_157 = "Contract.outerJoin";
  protected final String TEXT_158 = "_";
  protected final String TEXT_159 = "();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_160 = NL + "\t" + NL + "\t// SemChaveEstrangeira" + NL + "  \t";
  protected final String TEXT_161 = NL + "\t\tif (existeItem(\"Com";
  protected final String TEXT_162 = "\",uri.getPathSegments())) {" + NL + "\t\t\tsql += \" \" +  ";
  protected final String TEXT_163 = "Contract.outerJoin";
  protected final String TEXT_164 = "_";
  protected final String TEXT_165 = "();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_166 = NL + "\t\t" + NL + "\t\treturn sql;" + NL + "\t}" + NL + "" + NL + "\tprivate boolean existeItem(String ref, List<String> lista) {" + NL + "\t\tfor (String item : lista) {" + NL + "\t\t\tif (ref.compareToIgnoreCase(item)==0) return true;" + NL + "\t\t}" + NL + "\t\treturn false;" + NL + "\t}" + NL + "\t" + NL + "\t" + NL + "\t" + NL + "\tprivate String getOrderBy() {" + NL + "\t\tString campoOrder = getCampoOrder();" + NL + "\t\tif (campoOrder==null) return \"\";" + NL + "\t\treturn \" order by \" + campoOrder;" + NL + "\t}" + NL + "\tprotected String getCampoOrder() {" + NL + "\t\treturn null;" + NL + "\t}" + NL + "\t" + NL + "\t";
  protected final String TEXT_167 = NL + "\tprotected abstract String query";
  protected final String TEXT_168 = "(String param);" + NL + "\t";
  protected final String TEXT_169 = NL + "\t" + NL + "\t" + NL + "\tprotected Cursor query(String[] projection, String selection, String[] selectionArgs, String sortOrder) {" + NL + "\t\t return sQueryBuilder.query(mOpenHelper.getReadableDatabase()," + NL + "\t                projection," + NL + "\t                selection," + NL + "\t                selectionArgs," + NL + "\t                null," + NL + "\t                null," + NL + "\t                sortOrder" + NL + "\t        );" + NL + "\t}" + NL + "\tprotected Cursor querySinc(String[] projection, String selection, String[] selectionArgs, String sortOrder) {" + NL + "\t\t return sQueryBuilderSinc.query(mOpenHelper.getReadableDatabase()," + NL + "\t                projection," + NL + "\t                selection," + NL + "\t                selectionArgs," + NL + "\t                null," + NL + "\t                null," + NL + "\t                sortOrder" + NL + "\t        );" + NL + "\t}" + NL + "\tprotected Cursor queryRaw(String sql) {" + NL + "\t\t//DCLog.d(DCLog.DATABASE_ADM,this,sql);" + NL + "\t\tDCLog.d(DCLog.QUERY_SQL,this,sql);" + NL + "\t\tfinal SQLiteDatabase db = mOpenHelper.getReadableDatabase();" + NL + "\t\treturn db.rawQuery(sql,null);" + NL + "\t}" + NL + "\t" + NL + "\tpublic String getType(UriMatcher sUriMatcher, Uri uri) {" + NL + "\t\tswitch (sUriMatcher.match(uri)) {" + NL + "            case ";
  protected final String TEXT_170 = ":" + NL + "            {" + NL + "                return ";
  protected final String TEXT_171 = "Contract.getContentType();" + NL + "            }" + NL + "            case ";
  protected final String TEXT_172 = "_ID:" + NL + "            {" + NL + "            \treturn ";
  protected final String TEXT_173 = "Contract.getContentItemType();" + NL + "            }";
  protected final String TEXT_174 = NL + "\t\t\tcase ";
  protected final String TEXT_175 = ":" + NL + "            {" + NL + "\t            return ";
  protected final String TEXT_176 = "Contract.getContentType();" + NL + "            }" + NL + "\t\t";
  protected final String TEXT_177 = NL + "\t\t}\t" + NL + "\t\treturn null;" + NL + "\t}" + NL + "\t" + NL + "\tpublic Uri insert(Uri uri, ContentValues values) {" + NL + "\t\tfinal SQLiteDatabase db = mOpenHelper.getWritableDatabase();" + NL + "\t\tUri returnUri;" + NL + "\t\tlong idNovo = getMaxId(db)+1;" + NL + "\t\tvalues.put(";
  protected final String TEXT_178 = "Contract.COLUNA_CHAVE, idNovo);" + NL + "\t\tlong _id = db.insert(";
  protected final String TEXT_179 = "Contract.TABLE_NAME, null, values);" + NL + "\t\tif (_id > 0) {" + NL + "\t\t\t//DCLog.d(DCLog.DATABASE_CRUD,this,\"insert \" + ";
  protected final String TEXT_180 = "Contract.TABLE_NAME + \"  \" + values.toString() + \" (id:\" + _id + \")\");" + NL + "\t\t\tDCLog.d(DCLog.DATABASE_CRUD,this,\"insert \" + values.toString() + \" (id:\" + _id + \")\");" + NL + "\t\t\treturnUri = ";
  protected final String TEXT_181 = "Contract.build";
  protected final String TEXT_182 = "Uri(idNovo);" + NL + "\t\t\tvalues.put(";
  protected final String TEXT_183 = "Contract.COLUNA_OPERACAO_SINC,\"I\");" + NL + "\t\t\tinsereSinc(db,values);" + NL + "\t\t\tnotificaUriRelacionadas();" + NL + "\t\t\tnotificaOutrasUri(mProvider.getContext().getContentResolver());" + NL + "\t\t} else {" + NL + "\t\t\tthrow new android.database.SQLException(\"Falha no insert em \" + uri);" + NL + "\t\t}" + NL + "\t\treturn returnUri;" + NL + "\t}" + NL + "\t" + NL + "\t" + NL + "\t// considerando com o mesmo princ?pio do insert." + NL + "\t// delete na tabela atual e verific" + NL + "\tpublic boolean delete(UriMatcher sUriMatcher, Uri uri, String selection, String[] selectionArgs) {" + NL + "\t\tfinal SQLiteDatabase db = mOpenHelper.getWritableDatabase();" + NL + "\t\tint linhaDelete =0;" + NL + "\t\tswitch (sUriMatcher.match(uri)) {" + NL + "\t\t\tcase ";
  protected final String TEXT_184 = "_DELETE_SINC: {" + NL + "\t\t\t\tString id = uri.getPathSegments().get(2);" + NL + "\t\t\t\tCursor cursor = db.query(";
  protected final String TEXT_185 = "Contract.TABLE_NAME,null,";
  protected final String TEXT_186 = "Contract.COLUNA_CHAVE + \" = ? \",new String[]{id},null,null,null);" + NL + "\t\t\t\tif (cursor.moveToFirst()) {" + NL + "\t\t\t\t\tContentValues valores = new ContentValues();" + NL + "\t\t\t\t\tDatabaseUtils.cursorRowToContentValues(cursor, valores);" + NL + "\t\t\t\t\tlinhaDelete = db.delete(";
  protected final String TEXT_187 = "Contract.TABLE_NAME, ";
  protected final String TEXT_188 = "Contract.COLUNA_CHAVE + \" = ? \", new String[]{id});" + NL + "\t\t\t\t\tDCLog.d(DCLog.DATABASE_CRUD,this,\"delete \" + ";
  protected final String TEXT_189 = "Contract.TABLE_NAME + \"(id:\" + id + \")\");" + NL + "\t\t\t\t\tvalores.put(";
  protected final String TEXT_190 = "Contract.COLUNA_OPERACAO_SINC, \"D\");" + NL + "\t\t\t\t\tinsereSinc(db,valores);" + NL + "\t\t\t\t}" + NL + "\t\t\t\tnotificaUriRelacionadas();" + NL + "\t\t\t\tmProvider.getContext().getContentResolver().notifyChange(";
  protected final String TEXT_191 = "Contract.buildAll(), null);" + NL + "\t\t\t\tbreak;" + NL + "\t\t\t}" + NL + "\t\t\tcase ";
  protected final String TEXT_192 = "_DELETE_ALL_SINC: {" + NL + "\t\t\t\tlinhaDelete = db.delete(";
  protected final String TEXT_193 = "Contract.TABLE_NAME_SINC, null, null);" + NL + "\t\t\t\tbreak;" + NL + "\t\t\t}" + NL + "\t\t\tcase ";
  protected final String TEXT_194 = "_DELETE_RECREATE: {" + NL + "\t\t\t\tlinhaDelete = db.delete(";
  protected final String TEXT_195 = "Contract.TABLE_NAME, null, null);" + NL + "\t\t\t\tbreak;" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\treturn true;" + NL + "\t}" + NL + "\t" + NL + "\t" + NL + "\tpublic boolean update(Uri uri, ContentValues values, String selection, String[] selectionArgs) {" + NL + "\t\tfinal SQLiteDatabase db = mOpenHelper.getWritableDatabase();" + NL + "\t\tint linhaUpdate =0;" + NL + "\t\tDCLog.d(DCLog.DATABASE_CRUD,this,\"update2 \" + values.toString() );" + NL + "\t\tlinhaUpdate = db.update(";
  protected final String TEXT_196 = "Contract.TABLE_NAME, values, selection, selectionArgs);" + NL + "\t\tnotificaOutrasUri(mProvider.getContext().getContentResolver());" + NL + "\t\treturn true;" + NL + "\t}" + NL + "\tpublic boolean update(Uri uri, ContentValues values) {" + NL + "\t\tfinal SQLiteDatabase db = mOpenHelper.getWritableDatabase();" + NL + "\t\tint linhaUpdate =0;" + NL + "\t\tString selection = ";
  protected final String TEXT_197 = "Contract.COLUNA_CHAVE + \" = ? \";" + NL + "\t\tString dados[] = {values.get(";
  protected final String TEXT_198 = "Contract.COLUNA_CHAVE).toString()};" + NL + "\t\tDCLog.d(DCLog.DATABASE_CRUD,this,\"update1 \" + values.toString() );" + NL + "\t\tlinhaUpdate = db.update(";
  protected final String TEXT_199 = "Contract.TABLE_NAME, values, selection, dados);" + NL + "\t\tvalues.put(";
  protected final String TEXT_200 = "Contract.COLUNA_OPERACAO_SINC,\"A\");" + NL + "\t\tinsereSinc(db,values);" + NL + "\t\tnotificaOutrasUri(mProvider.getContext().getContentResolver());" + NL + "\t\treturn true;" + NL + "\t}" + NL + "\t" + NL + "\tprivate void insereSinc(SQLiteDatabase db, ContentValues values) {" + NL + "\t\tdb.insert(";
  protected final String TEXT_201 = "Contract.TABLE_NAME_SINC, null, values);" + NL + "\t\tnotificaUriOperacoes();" + NL + "\t}" + NL + "\t" + NL + "\tprotected abstract void notificaOutrasUri(ContentResolver resolver);" + NL + "\t" + NL + "\t" + NL + "\t// Notificar todas as uris de entidades que possuem chave estrangeira dessa entidade." + NL + "\tprivate void notificaUriRelacionadas() {" + NL + "\t\t// ComChaveEstrangeira" + NL + "  \t";
  protected final String TEXT_202 = NL + "\t\tmProvider.getContext().getContentResolver().notifyChange(";
  protected final String TEXT_203 = "Contract.buildAllCom";
  protected final String TEXT_204 = "(), null);" + NL + "\t\tmProvider.getContext().getContentResolver().notifyChange(";
  protected final String TEXT_205 = "Contract.buildAllSem";
  protected final String TEXT_206 = "(), null);" + NL + "\t";
  protected final String TEXT_207 = NL + "\t}" + NL + "\tprivate void notificaUriOperacoes() {" + NL + "\t";
  protected final String TEXT_208 = NL + "\t\tmProvider.getContext().getContentResolver().notifyChange(";
  protected final String TEXT_209 = "Contract.build";
  ...
  protected final String TEXT_212 = "Contract.COLUNA_CHAVE)};" + NL + "\t\t\t\tCursor retCursor = query(null, sPorChaveSel, args, null);" + NL + "\t\t\t\tif (retCursor.moveToFirst()) {" + NL + "\t\t\t\t\t\tdb.update(";
  protected final String TEXT_213 = "Contract.TABLE_NAME,value,sPorChaveSel,args);" + NL + "\t\t\t\t\t\t//DCLog.d(DCLog.DATABASE_CRUD,this,\"update (bulk \" + ";
  protected final String TEXT_214 = "Contract.TABLE_NAME + \"  \" + values.toString());" + NL + "\t\t\t\t\t\tDCLog.d(DCLog.DATABASE_CRUD,this,\"update (bulk id:\" + value.get(";
  protected final String TEXT_215 = "Contract.COLUNA_CHAVE) + \")\" + values.toString());" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tlong _id = db.insert(";
  protected final String TEXT_216 = "Contract.TABLE_NAME, null, value);" + NL + "\t\t\t\t\tif (_id != -1) {" + NL + "\t\t\t\t\t\t//DCLog.d(DCLog.DATABASE_CRUD,this,\"insert (bulk)\" + ";
  protected final String TEXT_217 = "Contract.TABLE_NAME + \"  \" + values.toString() + \" (id:\" + _id + \")\");" + NL + "\t\t\t\t\t\tDCLog.d(DCLog.DATABASE_CRUD,this,\"insert (bulk)\" + values.toString() + \" (id:\" + _id + \")\");" + NL + "\t\t\t\t\t\treturnCount++;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "            }" + NL + "            db.setTransactionSuccessful();" + NL + "            notificaUriOperacoes();" + NL + "   \t\t} finally {" + NL + " \t\t\tdb.endTransaction();" + NL + "        }" + NL + "        return returnCount;" + NL + "    }" + NL + "\tpublic int bulkInsertOld(Uri uri, ContentValues[] values) {" + NL + "    \tfinal SQLiteDatabase db = mOpenHelper.getWritableDatabase();" + NL + "        db.beginTransaction();" + NL + "        int returnCount = 0;" + NL + "        try {" + NL + "        \tfor (ContentValues value : values) {" + NL + "            \tlong _id = db.insert(";
  protected final String TEXT_218 = "Contract.TABLE_NAME, null, value);" + NL + "            \tif (_id != -1) {" + NL + "            \t\treturnCount++;" + NL + "            \t}" + NL + "            }" + NL + "            db.setTransactionSuccessful();" + NL + "   \t\t} finally {" + NL + " \t\t\tdb.endTransaction();" + NL + "        }" + NL + "        return returnCount;" + NL + "    }" + NL + "    " + NL + "    " + NL + "    public long getMaxId(SQLiteDatabase db) {" + NL + "\t\tString sql = \"select max(\" + ";
  protected final String TEXT_219 = "Contract.COLUNA_CHAVE + \") from \" + ";
  protected final String TEXT_220 = "Contract.TABLE_NAME;" + NL + "\t\treturn this.getNumeroSql(sql,db);" + NL + "\t}" + NL + "\t" + NL + "\t// Arquitetura - Padrao" + NL + "\tprotected long getNumeroSql(String sql,SQLiteDatabase db) {" + NL + "\t\tlong saida = 0;" + NL + "\t\tCursor c = null;" + NL + "\t\ttry {" + NL + "\t\t\tc =db.rawQuery(sql, null);" + NL + "\t\t\tc.moveToFirst();" + NL + "\t\t\tsaida = c.getLong(0);" + NL + "\t\t} catch (SQLException e) {" + NL + "\t\t\tDCLog.e(DCLog.DATABASE_ERRO_CORE, this, e);" + NL + "\t\t} finally {" + NL + "\t\t\tif (c != null && !c.isClosed()) {" + NL + "\t\t\t\tc.close();" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\treturn saida;" + NL + "\t}" + NL + "    " + NL + "}";
