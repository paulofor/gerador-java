...
public class MainActivityBaseGcm
{
  protected static String nl;
  public static synchronized MainActivityBaseGcm create(String lineSeparator)
  {
    nl = lineSeparator;
    MainActivityBaseGcm result = new MainActivityBaseGcm();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_6 = ".template.R;" + NL + "" + NL + "" + NL + "" + NL + "public abstract class MainActivityBaseGcm extends AppCompatActivity {" + NL + "" + NL + "\t@Override" + NL + "    protected final void onCreate(Bundle savedInstanceState) {" + NL + "        super.onCreate(savedInstanceState);" + NL + "        setContentView(getLayoutResource());" + NL + "        inicializaToolbar();" + NL + "    }" + NL + "" + NL + "   \tprivate void inicializaToolbar() {" + NL + "        Toolbar toolbar = (Toolbar) this.findViewById(getToolbarResource());" + NL + "        toolbar.setTitle(getTitulo());" + NL + "        setSupportActionBar(toolbar);" + NL + "    }" + NL + "" + NL + "" + NL + "    protected abstract int getLayoutResource();" + NL + "    protected abstract int getToolbarResource();" + NL + "    protected abstract String getTitulo();" + NL + "" + NL + "}";
