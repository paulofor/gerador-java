...
public class DetalheCallbackHtmlBase
{
  ...
  protected final String TEXT_9 = "DadosParseBase dadosParse;" + NL + "\tprotected boolean ligaColetaLista = false;" + NL + "\tprotected String urlCorrente = null;" + NL + "\tprotected boolean loop = false;" + NL + "\tprivate String urlOrigem = null;" + NL + "\t" + NL + "\t@Override" + NL + "\tpublic URL getJsonUrl() throws MalformedURLException {" + NL + "\t\treturn null;" + NL + "\t}" + NL + "\t// Se a pagina estiver com erro de acentos e precisa usar um versao de charset diferente." + NL + "\t// Possibilidades: CallbackParseHtml.HTML4_CHARSET ou CallbackParseHtml.HTML5_CHARSET" + NL + "\t@Override" + NL + "\tpublic String getCharSet() {" + NL + "\t\treturn null;" + NL + "\t}" + NL + "\t" + NL + "\tprotected String getUrlPrefixo() {" + NL + "\t\treturn \"\";" + NL + "\t}" + NL + "\t" + NL + "\t@Override" + NL + "\tpublic final URL getUrl() throws MalformedURLException {" + NL + "\t\tif (urlCorrente==null)" + NL + "\t\t\turlCorrente = dadosParse.getUrlDetalhe();" + NL + "\t\tif (urlCorrente.indexOf(\"http\")==-1)" + NL + "\t\t\tif (urlCorrente.indexOf(0)!='/')" + NL + "\t\t\t\turlCorrente = getUrlPrefixo() + \"/\" + urlCorrente;" + NL + "\t\t\telse" + NL + "\t\t\t\turlCorrente = getUrlPrefixo() + urlCorrente;" + NL + "\t\turlOrigem = urlCorrente;" + NL + "\t\tURL url = new URL(urlCorrente);" + NL + "\t\treturn url;" + NL + "\t}" + NL + "\t" + NL + "\tprotected String getUrlOrigem() {" + NL + "\t\treturn urlOrigem;" + NL + "\t}" + NL + "" + NL + "\t@Override" + NL + "\tpublic final void setDados(IDadosParse paramIDadosParse) {" + NL + "\t\tdadosParse = (";
