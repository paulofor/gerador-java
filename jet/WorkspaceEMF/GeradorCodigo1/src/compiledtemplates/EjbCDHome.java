...
public class EjbCDHome
{
  protected static String nl;
  public static synchronized EjbCDHome create(String lineSeparator)
  {
    nl = lineSeparator;
    EjbCDHome result = new EjbCDHome();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_3 = "CDHome extends EJBHome {";
  protected final String TEXT_4 = NL + "    ";
  protected final String TEXT_5 = "CD create() throws RemoteException, CreateException;" + NL + "}" + NL;
