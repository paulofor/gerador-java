...
public class GeradorJetoil {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		AplicacaoWrapper aplicacao = new AplicacaoWrapper();
		
		aplicacao.setNomeAplicacao("jetoil");
		aplicacao.setArquivoEcore("C:/WorkspaceEMF/ImportacaoModelo/model/JetOil.ecore");
		aplicacao.setPathWorkspace("C:/ArquivosGeradorWorkspace/");
		aplicacao.setNomeProjetoWorkspace("ProjetoJetoil");
		aplicacao.setNomePacote("jetoil");
