...
public class ContractEntidade
{
  ...
  protected final String TEXT_85 = " = \" + TABLE_NAME_SINC + \".\" + COLUNA_CHAVE + \" \";   " + NL + "\t}" + NL + " \t";
  protected final String TEXT_86 = NL + "\t// Com chave" + NL + "\t";
  protected final String TEXT_87 = NL + "\t";
  protected final String TEXT_88 = NL + "\tpublic static String innerJoin";
  protected final String TEXT_89 = "_";
  protected final String TEXT_90 = "() {" + NL + "\t\treturn \" inner join \" + ";
  protected final String TEXT_91 = "Contract.TABLE_NAME + \" on \" + ";
  protected final String TEXT_92 = "Contract.TABLE_NAME + \".\" + ";
  protected final String TEXT_93 = "Contract.COLUNA_CHAVE + \" = \" + TABLE_NAME + \".\" + COLUNA_";
  protected final String TEXT_94 = " + \" \";  " + NL + "\t}" + NL + "\tpublic static String innerJoinSinc";
  protected final String TEXT_95 = "_";
  protected final String TEXT_96 = "() {" + NL + "\t\treturn \" inner join \" + ";
  protected final String TEXT_97 = "Contract.TABLE_NAME_SINC + \" on \" + ";
  protected final String TEXT_98 = "Contract.TABLE_NAME_SINC + \".\" + ";
  protected final String TEXT_99 = "Contract.COLUNA_CHAVE + \" = \" + TABLE_NAME_SINC + \".\" + COLUNA_";
  protected final String TEXT_100 = " + \" \";  " + NL + "\t}" + NL + "\tpublic static String outerJoin";
  protected final String TEXT_101 = "_";
  protected final String TEXT_102 = "() {" + NL + "\t\treturn \" left outer join \" + ";
  protected final String TEXT_103 = "Contract.TABLE_NAME + \" on \" + ";
  protected final String TEXT_104 = "Contract.TABLE_NAME + \".\" + ";
  protected final String TEXT_105 = "Contract.COLUNA_CHAVE + \" = \" + TABLE_NAME + \".\" + COLUNA_";
  protected final String TEXT_106 = " + \" \"; " + NL + "\t}" + NL + "\tpublic static String outerJoinSinc";
  protected final String TEXT_107 = "_";
  protected final String TEXT_108 = "() {" + NL + "\t\treturn \" left outer join \" + ";
  protected final String TEXT_109 = "Contract.TABLE_NAME_SINC + \" on \" + ";
  protected final String TEXT_110 = "Contract.TABLE_NAME_SINC + \".\" + ";
  protected final String TEXT_111 = "Contract.COLUNA_CHAVE + \" = \" + TABLE_NAME_SINC + \".\" + COLUNA_";
  protected final String TEXT_112 = " + \" \";   " + NL + "\t}" + NL + "\t";
  protected final String TEXT_113 = NL + "\t" + NL + "\tpublic static MontadorDaoI adicionaMontador";
  protected final String TEXT_114 = " (MontadorDaoI montador) {" + NL + "\t\t((MontadorDaoComposite)montador).adicionaMontador(";
  protected final String TEXT_115 = "Contract.getMontador(), \"";
  protected final String TEXT_116 = "_";
  protected final String TEXT_117 = "\");" + NL + "\t\treturn montador;" + NL + "\t}" + NL + "\tpublic static Uri adiciona";
  protected final String TEXT_118 = "(Uri uri) {" + NL + "\t\treturn uri.buildUpon().appendPath(\"Com";
  protected final String TEXT_119 = "\").build();" + NL + "\t}" + NL + " \t";
  protected final String TEXT_120 = NL + "\t" + NL + "\t" + NL + "\t" + NL + "\t" + NL + "\tpublic static String camposOrdenados() " + NL + "\t{" + NL + "\t\treturn ";
  protected final String TEXT_121 = "\" \" + TABLE_NAME + \".\" + COLUNA_";
  protected final String TEXT_122 = "  " + NL + "\t\t";
  protected final String TEXT_123 = "+ \" , \" + TABLE_NAME + \".\" + COLUNA_";
  protected final String TEXT_124 = " " + NL + "\t\t";
  protected final String TEXT_125 = NL + "\t\t";
  protected final String TEXT_126 = NL + "\t\t+ \" , \" + TABLE_NAME + \".\" + COLUNA_";
  protected final String TEXT_127 = " " + NL + "\t\t";
  protected final String TEXT_128 = NL + "\t\t;" + NL + "\t}" + NL + "\t" + NL + "\t" + NL + "\t" + NL + "\tpublic static String camposOrdenadosSinc() " + NL + "\t{" + NL + "\t\treturn ";
  protected final String TEXT_129 = "\" ";
  protected final String TEXT_130 = " \" " + NL + "\t\t";
  protected final String TEXT_131 = "+ \" ,";
  protected final String TEXT_132 = " \" " + NL + "\t\t";
  protected final String TEXT_133 = NL + "\t\t";
  protected final String TEXT_134 = NL + "\t\t+ \" , \" + TABLE_NAME_SINC + \".\" + COLUNA_";
  protected final String TEXT_135 = " " + NL + "\t\t";
  protected final String TEXT_136 = NL + "\t\t+ \" ,";
  protected final String TEXT_137 = "_sinc.operacao_sinc \"" + NL + "\t\t;" + NL + "\t}" + NL + "\t" + NL + "\t" + NL + "\tpublic static MontadorDaoComposite getMontadorComposto() {" + NL + "\t\tMontadorDaoComposite montador = new MontadorDaoComposite();" + NL + "\t\tmontador.adicionaMontador(getMontador(),null);" + NL + "\t\treturn montador;" + NL + "\t}" + NL + "\tpublic static MontadorDaoI getMontador() {" + NL + "\t\treturn new ";
  protected final String TEXT_138 = "Montador();" + NL + "\t}" + NL + "\t" + NL + "\t" + NL + "\t// ComChaveEstrangeira" + NL + "  \t";
  protected final String TEXT_139 = NL + "\tpublic static Uri buildAllCom";
  protected final String TEXT_140 = "() {" + NL + "\t\tUri saida = getContentUri();" + NL + "\t\tsaida = saida.buildUpon().appendPath(";
  protected final String TEXT_141 = "Contract.COM_COMPLEMENTO).build();" + NL + "\t\tsaida = saida.buildUpon().appendPath(\"Com";
  protected final String TEXT_142 = "\").build();" + NL + "\t\treturn saida;" + NL + "\t}" + NL + "\t/*" + NL + "\tpublic static Uri buildAllSem";
  protected final String TEXT_143 = "() {" + NL + "\t\tUri saida = CONTENT_URI;" + NL + "\t\tsaida = saida.buildUpon().appendPath(";
  protected final String TEXT_144 = "Contract.COM_COMPLEMENTO).build();" + NL + "\t\tsaida = saida.buildUpon().appendPath(\"Sem";
  protected final String TEXT_145 = "\").build();" + NL + "\t\treturn saida;" + NL + "\t}" + NL + "\t*/\t" + NL + "\t";
  protected final String TEXT_146 = NL + "\t" + NL + "\t// SemChaveEstrangeira" + NL + "  \t";
  protected final String TEXT_147 = NL + "\t";
  protected final String TEXT_148 = NL + "\tpublic static Uri buildAllCom";
  protected final String TEXT_149 = "() {" + NL + "\t\tUri saida = getContentUri();" + NL + "\t\tsaida = saida.buildUpon().appendPath(";
  protected final String TEXT_150 = "Contract.COM_COMPLEMENTO).build();" + NL + "\t\tsaida = saida.buildUpon().appendPath(\"Com";
  protected final String TEXT_151 = "\").build();" + NL + "\t\treturn saida;" + NL + "\t}\t" + NL + "\tpublic static Uri buildAllSem";
  protected final String TEXT_152 = "() {" + NL + "\t\tUri saida = getContentUri();" + NL + "\t\tsaida = saida.buildUpon().appendPath(";
  protected final String TEXT_153 = "Contract.COM_RETIRADA).build();" + NL + "\t\tsaida = saida.buildUpon().appendPath(\"Sem";
  protected final String TEXT_154 = "\").build();" + NL + "\t\treturn saida;" + NL + "\t}\t" + NL + "\t";
  protected final String TEXT_155 = NL + "\t";
  protected final String TEXT_156 = NL + "\t" + NL + "\tpublic static Uri buildDeleteAllSinc() {" + NL + "\t\tUri saida = getContentUri();" + NL + "\t\tsaida = saida.buildUpon().appendPath(\"DeleteAllSinc\").build();" + NL + "\t\treturn saida;" + NL + "\t}" + NL + "\tpublic static Uri buildDeleteAllRecreate() {" + NL + "\t\tUri saida = getContentUri();" + NL + "\t\tsaida = saida.buildUpon().appendPath(\"DeleteAllRecreate\").build();" + NL + "\t\treturn saida;" + NL + "\t}" + NL + "\tpublic static Uri buildDeleteSinc(int id) {" + NL + "\t\tUri saida = getContentUri();" + NL + "\t\tsaida = saida.buildUpon().appendPath(\"DeleteSinc\").build();" + NL + "\t\treturn ContentUris.withAppendedId(saida, id);" + NL + "\t}" + NL + "\t" + NL + "\t" + NL + "\tpublic static List<";
  protected final String TEXT_157 = "> converteLista(Cursor data) {" + NL + "\t\treturn converteLista(data, getMontador());" + NL + "\t}" + NL + "\tpublic static List<";
  protected final String TEXT_158 = "> converteLista(Cursor data, MontadorDaoI montador) {" + NL + "        //MontadorDaoI montador = getMontador();" + NL + "        List lista = new ArrayList();" + NL + "        try {" + NL + "            lista = getListaSqlListaInterna(data, montador);" + NL + "        } catch (Exception e) {" + NL + "            lista = new ArrayList();" + NL + "        }" + NL + "        return lista;" + NL + "    }" + NL + "    private static List getListaSqlListaInterna(Cursor c, MontadorDaoI montador) throws DaoException {" + NL + "        ArrayList<DCIObjetoDominio> listaSaida = new ArrayList<DCIObjetoDominio>();" + NL + "        int numRows = c.getCount();" + NL + "        boolean insere = false;" + NL + "        DCIObjetoDominio objeto = null;" + NL + "        DaoItemRetorno retorno = null;" + NL + "        while (c.moveToNext()) {" + NL + "            try {" + NL + "                retorno = montador.extraiRegistroListaInterna(c, objeto);" + NL + "                insere = retorno.getInsere();" + NL + "                objeto = retorno.getObjeto();" + NL + "            } catch (Exception e) {" + NL + "                DCLog.e(DCLog.DATABASE_ERRO_CORE, null, e);" + NL + "            }" + NL + "            if (insere) {" + NL + "                listaSaida.add(objeto);" + NL + "            }" + NL + "        }" + NL + "        return listaSaida;" + NL + "    }" + NL + "\t" + NL + "}";
