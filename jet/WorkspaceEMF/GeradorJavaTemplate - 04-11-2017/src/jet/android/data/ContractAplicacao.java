...
public class ContractAplicacao
{
  ...
  protected final String TEXT_4 = "\";" + NL + "\t//public static final Uri BASE_CONTENT_URI = Uri.parse(\"content://\" + CONTENT_AUTHORITY);" + NL + "\t" + NL + "\tprivate static AplicacaoContract contract = null;" + NL + "\tprotected Application application = null;" + NL + "\t" + NL + "\t// Pode no futuro usar o NomePacote ?" + NL + "\tpublic abstract String getContentAuthority();" + NL + "" + NL + "\tpublic String getNomePacoteApp() {" + NL + "\t\treturn application.getPackageName();" + NL + "\t}" + NL + "" + NL + "\tpublic Uri getBaseContentUri() {" + NL + "\t\treturn Uri.parse(\"content://\" + getContentAuthority());" + NL + "\t}" + NL + "\t" + NL + "\tpublic static String getIdAplicacao() {" + NL + "\t\treturn contract.getContentAuthority();" + NL + "\t}" + NL + "\t" + NL + "\tpublic static void setAplicacaoContract(AplicacaoContract contract){" + NL + "\t\tAplicacaoContract.contract = contract;" + NL + "\t";
