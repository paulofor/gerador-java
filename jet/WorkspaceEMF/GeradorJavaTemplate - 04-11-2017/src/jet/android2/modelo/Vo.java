...
public class Vo
{
  ...
  protected final String TEXT_40 = "() {" + NL + "\t\t// relacionamento" + NL + "\t\t//if (";
  protected final String TEXT_41 = "==0 && this.get";
  protected final String TEXT_42 = "_";
  protected final String TEXT_43 = "()!=null) " + NL + "\t\t//\treturn get";
  protected final String TEXT_44 = "_";
  protected final String TEXT_45 = "().getId();" + NL + "\t\t//else" + NL + "\t\t\treturn ";
  protected final String TEXT_46 = ";" + NL + "\t}" + NL + "\tpublic void set";
  protected final String TEXT_47 = "(";
  protected final String TEXT_48 = " _valor) {" + NL + "\t\t";
  protected final String TEXT_49 = " = _valor;" + NL + "\t}";
  protected final String TEXT_50 = NL;
  protected final String TEXT_51 = "\t" + NL + "\tpublic String get";
  protected final String TEXT_52 = "Tela() {" + NL + "\t\tDecimalFormat df = new DecimalFormat(\"###,###.00\");" + NL + "\t\tString saida = df.format(";
  protected final String TEXT_53 = ");" + NL + "\t\treturn saida;" + NL + "\t}";
  protected final String TEXT_54 = NL;
  protected final String TEXT_55 = NL + "\tpublic String get";
  protected final String TEXT_56 = "DDMMAAAA() {" + NL + "\t\tif (";
  protected final String TEXT_57 = "==null) return null;" + NL + "        SimpleDateFormat formato = new SimpleDateFormat(\"dd/MM/yyyy\");" + NL + "        return formato.format(";
  protected final String TEXT_58 = ");" + NL + "    }";
  protected final String TEXT_59 = NL + "    public void set";
  protected final String TEXT_60 = "DDMMAAAAComBarra(String arg) {" + NL + "    \tDateFormat formatter = new SimpleDateFormat(\"dd/MM/yyyy\");" + NL + "\t\tDate date;" + NL + "\t\ttry {" + NL + "\t\t\tdate = formatter.parse(arg);" + NL + "\t\t\t";
  protected final String TEXT_61 = " = new Timestamp(date.getTime());" + NL + "\t\t} catch (ParseException e) {" + NL + "\t\t\tDCLog.e(DCLog.MODELO, this, e);" + NL + "\t\t}" + NL + "    }" + NL + "    public void set";
  protected final String TEXT_62 = "DDMMAAAAComTraco(String arg) {" + NL + "    \tDateFormat formatter = new SimpleDateFormat(\"dd-MM-yyyy\");" + NL + "\t\tDate date;" + NL + "\t\ttry {" + NL + "\t\t\tdate = formatter.parse(arg);" + NL + "\t\t\t";
  protected final String TEXT_63 = " = new Timestamp(date.getTime());" + NL + "\t\t} catch (ParseException e) {" + NL + "\t\t\tDCLog.e(DCLog.MODELO, this, e);" + NL + "\t\t}" + NL + "    }";
  protected final String TEXT_64 = NL + NL + NL + NL;
  protected final String TEXT_65 = NL + "\tpublic String get";
  protected final String TEXT_66 = "HHMM() {" + NL + "\t\tif (";
  protected final String TEXT_67 = "==null) return null;" + NL + "        SimpleDateFormat formato = new SimpleDateFormat(\"HH:mm\");" + NL + "        return formato.format(";
  protected final String TEXT_68 = ");" + NL + "    }" + NL + "    public String get";
  protected final String TEXT_69 = "HHMMSS() {" + NL + "\t\tif (";
  protected final String TEXT_70 = "==null) return null;" + NL + "        SimpleDateFormat formato = new SimpleDateFormat(\"HH:mm:ss\");" + NL + "        return formato.format(";
  protected final String TEXT_71 = ");" + NL + "    }";
  protected final String TEXT_72 = NL + NL + NL + NL + "\tprivate String operacaoSinc = null;" + NL + "" + NL + "\tpublic String getOperacaoSinc() {" + NL + "\t\treturn operacaoSinc;" + NL + "\t}" + NL + "" + NL + "\tpublic void setOperacaoSinc(String valor) {" + NL + "\t\toperacaoSinc = valor;" + NL + "\t}" + NL + "" + NL + "\t/*" + NL + "\tpublic JSONObject JSonSinc() throws JSONException {" + NL + "\t\tJSONObject json = JSonSimples();" + NL + "\t\tjson.put(\"OperacaoSinc\", operacaoSinc);" + NL + "\t\treturn json;" + NL + "\t}" + NL + "\t*/" + NL + "\t" + NL + "\t" + NL + "\tprivate boolean salvaPreliminar = false;" + NL + "" + NL + "\tpublic void setSalvaPreliminar(boolean valor) {" + NL + "\t\tsalvaPreliminar = valor;" + NL + "\t}" + NL + "" + NL + "\tpublic boolean getSalvaPreliminar() {" + NL + "\t\treturn salvaPreliminar;" + NL + "\t}" + NL + "\t" + NL + "\t// ComChaveEstrangeira" + NL + "  \t";
  protected final String TEXT_73 = NL + "\tpublic long get";
  protected final String TEXT_74 = "LazyLoader() {" + NL + "\t\treturn ";
  protected final String TEXT_75 = ";" + NL + "\t} " + NL + "\t\t";
  protected final String TEXT_76 = NL + "\t" + NL + "\t" + NL + "\tprivate boolean somenteMemoria = true;" + NL + "" + NL + "\tpublic boolean getSomenteMemoria() {" + NL + "\t\treturn somenteMemoria;" + NL + "\t}" + NL + "" + NL + "\tpublic void setSomenteMemoria(boolean dado) {" + NL + "\t\tsomenteMemoria = dado;" + NL + "\t} " + NL + "\t" + NL + "\t" + NL + "\t// ------ AGREGADOS 2-------------------" + NL + "  \t// ComChaveEstrangeira" + NL + "  \t";
  protected final String TEXT_77 = NL + "\t\tpublic ";
  protected final String TEXT_78 = " get";
  protected final String TEXT_79 = "_";
  protected final String TEXT_80 = "() {" + NL + "\t\t\treturn getAgregado().get";
  protected final String TEXT_81 = "_";
  protected final String TEXT_82 = "();" + NL + "\t\t}" + NL + "\t\tpublic void set";
  protected final String TEXT_83 = "_";
  protected final String TEXT_84 = "(";
  protected final String TEXT_85 = " item) {" + NL + "\t\t\tgetAgregado().set";
