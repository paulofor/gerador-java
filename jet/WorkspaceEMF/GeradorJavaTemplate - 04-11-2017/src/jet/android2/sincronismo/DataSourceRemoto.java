...
public class DataSourceRemoto
{
  ...
  protected final String TEXT_3 = "\";" + NL + "" + NL + "    //public final String SERVER = \"10.0.2.2:52134\";" + NL + "    //public final String APLICACAO = null;" + NL + "" + NL + "" + NL + "    public static String getServer() {" + NL + "        return SERVER;" + NL + "    }" + NL + "    public static String getAplicacao() {" + NL + "        return APLICACAO;" + NL + "    }" + NL + "}";
