...
public class ObjetoRemote
{
  ...
  protected final String TEXT_11 = "Contract.getContentUri(), vetor);" + NL + "" + NL + " \t\t\tDCLog.d(DCLog.SINCRONIZACAO_JSON, this, \"Url:\" + url);" + NL + "            DCLog.d(DCLog.SINCRONIZACAO_JSON,this,buffer.toString());" + NL + "            " + NL + "            return tam;" + NL + "        } catch (Exception e) {" + NL + "        \tDCLog.e(DCLog.SINCRONIZACAO_JSON,this,\"Url:\" + urlEnt);" + NL + "        \tDCLog.e(DCLog.SINCRONIZACAO_JSON,this,e);" + NL + "        } finally {" + NL + "            if (urlConnection != null) {" + NL + "                urlConnection.disconnect();" + NL + "            }" + NL + "            if (reader != null) {" + NL + "                try {" + NL + "                    reader.close();" + NL + "                } catch (final IOException e) {" + NL + "                }" + NL + "            }" + NL + "        }" + NL + "        return tam;" + NL + "    }" + NL + "" + NL + "" + NL + "    public int listaSincronizadaDao(Context contexto, boolean delete, String codigoAplicacao) throws JSONException {" + NL + "        int tam = 0;" + NL + "        String urlEnt = getUrl(\"ListaSincronizada\");" + NL + "        String numeroTel = Telefone.getNumero(contexto);" + NL + "        urlEnt += \"?tmp=\" + numeroTel + \"&versao=\" + getVersaoSincronizacao() + \"&app=\" + codigoAplicacao;" + NL + "        HttpURLConnection urlConnection = null;" + NL + "        BufferedReader reader = null;" + NL + "        try {" + NL + "            URL url = new URL(urlEnt);" + NL + "            urlConnection = (HttpURLConnection) url.openConnection();" + NL + "            urlConnection.setRequestMethod(\"GET\");" + NL + "            urlConnection.setRequestProperty(\"Content-Type\", \"application/x-www-form-urlencoded\");" + NL + "            InputStream inputStream = urlConnection.getInputStream();" + NL + "            StringBuffer buffer = new StringBuffer();" + NL + "            if (inputStream == null) {" + NL + "                return tam;" + NL + "            }" + NL + "            reader = new BufferedReader(new InputStreamReader(inputStream));" + NL + "            String line;" + NL + "            JSONObject obj = null;" + NL + "            if ((line = reader.readLine()) != null) {" + NL + "                obj = new JSONObject(line);" + NL + "                buffer.append(line + \"\\n\");" + NL + "            }" + NL + "            if (buffer.length() == 0) {" + NL + "                return tam;" + NL + "            }" + NL + "            JSONArray lista = obj.getJSONArray(\"Lista\");" + NL + "            tam = lista.length();" + NL + "            ContentValues[] vetor = new ContentValues[lista.length()];" + NL + "            for (int x = 0 ; x < lista.length() ; x++) {" + NL + "                JSONObject item = lista.getJSONObject(x);" + NL + "                ContentValues valor = this.ContentValuesAtributos(item);" + NL + "                vetor[x] = valor;" + NL + "            }" + NL + "            if (delete) {" + NL + "                contexto.getContentResolver().delete(";
  protected final String TEXT_12 = "Contract.buildDeleteAllRecreate(), null, null);" + NL + "            }" + NL + "            contexto.getContentResolver().bulkInsert(";
  protected final String TEXT_13 = "Contract.getContentUri(), vetor);" + NL + " \t\t\tDCLog.d(DCLog.SINCRONIZACAO_JSON, this, \"Url:\" + url);" + NL + "            DCLog.d(DCLog.SINCRONIZACAO_JSON,this,buffer.toString());" + NL + "            return tam;" + NL + "        } catch (Exception e) {" + NL + "        \tDCLog.e(DCLog.SINCRONIZACAO_JSON,this,\"Url:\" + urlEnt);" + NL + "        \tDCLog.e(DCLog.SINCRONIZACAO_JSON,this,e);" + NL + "        } finally {" + NL + "            if (urlConnection != null) {" + NL + "                urlConnection.disconnect();" + NL + "            }" + NL + "            if (reader != null) {" + NL + "                try {" + NL + "                    reader.close();" + NL + "                } catch (final IOException e) {" + NL + "                }" + NL + "            }" + NL + "        }" + NL + "        return tam;" + NL + "    }" + NL + "" + NL + "" + NL + "" + NL + " \t" + NL + "    private JSONObject JSonAtributos(Cursor c) throws JSONException {" + NL + "        int pos = 0;" + NL + "        JSONObject json = new JSONObject();" + NL + "        ";
  protected final String TEXT_14 = "\tjson.put(\"";
  protected final String TEXT_15 = "\",c.getString(";
  protected final String TEXT_16 = "Contract.COL_";
  protected final String TEXT_17 = "));" + NL + "\t\t";
  protected final String TEXT_18 = NL + "        return json;" + NL + "    }" + NL + "     private JSONObject JSonAtributosSinc(Cursor c) throws JSONException {" + NL + "        JSONObject json = JSonAtributos(c);" + NL + "        json.put(\"OperacaoSinc\",c.getString(";
  protected final String TEXT_19 = "Contract.COL_OPERACAO_SINC));" + NL + "        return json;" + NL + "    }" + NL + "    " + NL + "" + NL + "    private ContentValues ContentValuesAtributos(JSONObject obj) throws JSONException {" + NL + "        ContentValues valores = new ContentValues();";
  protected final String TEXT_20 = NL + "\t\tvalores.put(";
  protected final String TEXT_21 = "Contract.COLUNA_";
  protected final String TEXT_22 = ", obj.getLong(\"";
  protected final String TEXT_23 = "\"));" + NL + "\t\t";
  protected final String TEXT_24 = NL + "\t\tvalores.put(";
  protected final String TEXT_25 = "Contract.COLUNA_";
  protected final String TEXT_26 = ", obj.getLong(\"";
  protected final String TEXT_27 = "\"));" + NL + "\t\t";
  protected final String TEXT_28 = "\t" + NL + "\t\tint val";
  protected final String TEXT_29 = " = 0;" + NL + "\t\tif (\"True\".equals(obj.getString(\"";
  protected final String TEXT_30 = "\"))) {" + NL + "\t\t\tval";
  protected final String TEXT_31 = " = 1;" + NL + "\t\t}" + NL + "\t\tvalores.put(";
  protected final String TEXT_32 = "Contract.COLUNA_";
  protected final String TEXT_33 = ", val";
  protected final String TEXT_34 = ");" + NL + "\t\t";
  protected final String TEXT_35 = NL + "\t\tvalores.put(";
  protected final String TEXT_36 = "Contract.COLUNA_";
  protected final String TEXT_37 = ", obj.getString(\"";
  protected final String TEXT_38 = "\"));" + NL + "\t\t";
  protected final String TEXT_39 = NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_40 = NL + "\t\t";
  protected final String TEXT_41 = "\t" + NL + "\t\tint val";
  protected final String TEXT_42 = " = 0;" + NL + "\t\tif (\"True\".equals(obj.getString(\"";
  protected final String TEXT_43 = "\"))) {" + NL + "\t\t\tval";
  protected final String TEXT_44 = " = 1;" + NL + "\t\t}" + NL + "\t\tvalores.put(";
  protected final String TEXT_45 = "Contract.COLUNA_";
  protected final String TEXT_46 = ", val";
  protected final String TEXT_47 = ");" + NL + "\t\t";
  protected final String TEXT_48 = NL + "\t\tvalores.put(";
  protected final String TEXT_49 = "Contract.COLUNA_";
  protected final String TEXT_50 = ", obj.getString(\"";
  protected final String TEXT_51 = "\"));" + NL + "\t\t";
  protected final String TEXT_52 = NL + "\t\t";
  protected final String TEXT_53 = NL + "        return valores;" + NL + "    }" + NL + "" + NL + "}" + NL + NL;
