...
public class DaoBase
{
  ...
  protected final String TEXT_13 = "\" ;" + NL + "\t}" + NL + "\tpublic  String orderByLista() {" + NL + "\t\treturn orderBy();" + NL + "\t}" + NL + "\tpublic  String whereLista() {" + NL + "\t\treturn \"\";" + NL + "\t}" + NL + "\tpublic  String whereListaConcatenado() {" + NL + "\t\treturn \"\";" + NL + "\t}" + NL + "\tpublic   static String orderBy() {" + NL + "\t\treturn \" order by \" + tabelaSelect() + \".";
  ...
  protected final String TEXT_101 = " = \" + id + orderByLista();" + NL + "       \tsetMontador(getMontadorAgrupado());" + NL + "      \treturn getListaSql(sql);" + NL + "\t}" + NL + "\tpublic boolean excluiPor";
  protected final String TEXT_102 = "(long id) throws DaoException{" + NL + "\t\tsetMontador(null);" + NL + "\t\tString sql;" + NL + "      \tsql = \"delete from \" + tabelaSelect() + " + NL + "       \t\" where ";
  protected final String TEXT_103 = " = \" + id;" + NL + "       \tthis.executaSql(sql);" + NL + "       \treturn true;" + NL + "\t}" + NL + "\t";
  protected final String TEXT_104 = NL + "\t" + NL + "\t";
  protected final String TEXT_105 = NL + "\t@Override" + NL + "\tpublic ";
  protected final String TEXT_106 = " obtemPorRel(long ";
  protected final String TEXT_107 = ", long ";
  protected final String TEXT_108 = ") throws DaoException {" + NL + "\t\tString sql = \"select \" + camposOrdenados() + \" from \" + tabelaSelect() +" + NL + "\t\t\t\t\" where ";
  protected final String TEXT_109 = " = \" + ";
  protected final String TEXT_110 = " + " + NL + "\t\t\t\t\" and ";
  protected final String TEXT_111 = " = \" + ";
  protected final String TEXT_112 = ";" + NL + "\t\treturn (";
  protected final String TEXT_113 = ") this.getObjeto(sql);" + NL + "\t}" + NL + "\t";
  protected final String TEXT_114 = NL + "\t" + NL + "\t// Tratamento de objetos que possuem FK nesse objeto para objetos associativos" + NL + "\t";
  protected final String TEXT_115 = NL + "\t//public List getPor";
  protected final String TEXT_116 = "(long id) throws DaoException{ // Padrao" + NL + "\tpublic List ListaPor";
  protected final String TEXT_117 = "(long id) throws DaoException{ // Combinar com Interface" + NL + "\t\tString sql;" + NL + "        sql = \"select \" + camposOrdenados() + \" , \" +" + NL + "        \t";
  protected final String TEXT_118 = "DaoBase.camposOrdenados() +" + NL + "        \t\" from \" + tabelaSelect() +" + NL + "        \t\" inner join \" + ";
  protected final String TEXT_119 = "DaoBase.tabelaSelect() +" + NL + "            \" on \" + ";
  protected final String TEXT_120 = "DaoBase.tabelaSelect() + \".";
  protected final String TEXT_121 = " = \" +" + NL + "            tabelaSelect() + \".";
  protected final String TEXT_122 = "\" +" + NL + "            \" where ";
  protected final String TEXT_123 = " = \" + id + \" \" +" + NL + "            criterioExclusao";
  protected final String TEXT_124 = "() + \" \" +" + NL + "            orderByLista();" + NL + "        MontadorDaoComposite montador = new MontadorDaoComposite();" + NL + "        montador.adicionaMontador(new ";
  protected final String TEXT_125 = "Montador(),null);" + NL + "        montador.adicionaMontador(new ";
  protected final String TEXT_126 = "Montador(), \"";
  protected final String TEXT_127 = "\");" + NL + "        setMontador(montador);" + NL + "        return getListaSqlListaInterna(sql);" + NL + "\t}" + NL + "\tpublic boolean excluiPor";
  protected final String TEXT_128 = "(long id) throws DaoException{" + NL + "\t\tString sql;" + NL + "      \tsql = \"delete from \" + tabelaSelect() + " + NL + "        \" where ";
  protected final String TEXT_129 = " = \" + id;" + NL + "       \tthis.executaSql(sql);" + NL + "       \treturn true;" + NL + "\t}" + NL + "\tprotected String criterioExclusao";
  protected final String TEXT_130 = "() {" + NL + "\t\treturn \"\";" + NL + "\t}" + NL + "\t";
  protected final String TEXT_131 = NL + "\t" + NL + "\t";
  protected final String TEXT_132 = NL + "\t" + NL + "\t" + NL + "\t" + NL + "\t// Relacionamento onde esse objeto ? chave estrangeira de outro. ????" + NL + "\t";
  protected final String TEXT_133 = NL + "\tprivate boolean _obtem";
  protected final String TEXT_134 = "_";
  protected final String TEXT_135 = " = false;" + NL + "\tpublic void setObtem";
  protected final String TEXT_136 = "_";
  protected final String TEXT_137 = "() {" + NL + "\t\t_obtem";
  protected final String TEXT_138 = "_";
  protected final String TEXT_139 = " = true;" + NL + "\t}" + NL + "\tprotected String outterJoin";
  protected final String TEXT_140 = "_";
  protected final String TEXT_141 = "() {" + NL + "\t\treturn \" left outer join \" + ";
  protected final String TEXT_142 = "DaoBase.tabelaSelect() + \" on \" + ";
  protected final String TEXT_143 = "DaoBase.tabelaSelect() + \".";
  protected final String TEXT_144 = " = \" + tabelaSelect() + \".";
  protected final String TEXT_145 = " \";  " + NL + "\t}" + NL + "\tpublic boolean atualiza";
  protected final String TEXT_146 = "(long ";
  protected final String TEXT_147 = ", long ";
  protected final String TEXT_148 = ") throws DaoException{" + NL + "\t\tString sql;" + NL + "      \tsql = \"update \" + tabelaSelect() + " + NL + "      \t\" set ";
  protected final String TEXT_149 = "  = \" + ";
  protected final String TEXT_150 = " +" + NL + "        \" where ";
  protected final String TEXT_151 = " = \" +  ";
  protected final String TEXT_152 = ";" + NL + "       \tthis.executaSql(sql);" + NL + "       \treturn true;" + NL + "\t}" + NL + "\t";
  protected final String TEXT_153 = NL + "\tpublic static String innerJoin";
  protected final String TEXT_154 = "_";
  protected final String TEXT_155 = "() {" + NL + "\t\treturn \" inner join \" + ";
  protected final String TEXT_156 = "DaoBase.tabelaSelect() + \" on \" + ";
  protected final String TEXT_157 = "DaoBase.tabelaSelect() + \".";
  protected final String TEXT_158 = " = \" + tabelaSelect() + \".";
  protected final String TEXT_159 = " \";  " + NL + "\t}" + NL + "\t";
  protected final String TEXT_160 = NL + " \t";
  protected final String TEXT_161 = NL + "\t// ********************************************************************\t" + NL + "\t" + NL + "\t" + NL + "\t" + NL + "\tprotected String camposOrdenadosJoin()" + NL + "    {" + NL + "        String saida = camposOrdenados();";
  protected final String TEXT_162 = NL + "\t\tsaida += (this._obtem";
  protected final String TEXT_163 = "_";
  protected final String TEXT_164 = "?\" , \" +";
  protected final String TEXT_165 = "DaoBase.camposOrdenados():\"\");";
  protected final String TEXT_166 = NL + "        return saida;" + NL + "    }" + NL + "    " + NL + "    public void limpaObtem()" + NL + "    {";
  protected final String TEXT_167 = NL + "\t\t_obtem";
  protected final String TEXT_168 = "_";
  protected final String TEXT_169 = " = false;";
  protected final String TEXT_170 = NL + "    }" + NL + "    " + NL + "\tprotected String outterJoinAgrupado()" + NL + "    {" + NL + "        String saida = \" \";";
  protected final String TEXT_171 = NL + "\t\tsaida += (this._obtem";
  protected final String TEXT_172 = "_";
  protected final String TEXT_173 = "? outterJoin";
  protected final String TEXT_174 = "_";
  protected final String TEXT_175 = "() + \" \":\"\");";
  protected final String TEXT_176 = NL + "        return saida;" + NL + "    }" + NL + "    protected MontadorDaoI getMontadorAgrupado()" + NL + "    {" + NL + "        MontadorDaoComposite montador = new MontadorDaoComposite();" + NL + "        montador.adicionaMontador(new ";
  protected final String TEXT_177 = "Montador(), null);";
  protected final String TEXT_178 = NL + "\t\tif (this._obtem";
  protected final String TEXT_179 = "_";
  protected final String TEXT_180 = ")" + NL + "            montador.adicionaMontador(new ";
  protected final String TEXT_181 = "Montador(), \"";
  protected final String TEXT_182 = "_";
  protected final String TEXT_183 = "\");";
  protected final String TEXT_184 = NL + "         return montador;" + NL + "    }" + NL + "\t" + NL + "\t" + NL + "}";
