...
public class ListaCallbackHtmlBase
{
  ...
  protected final String TEXT_10 = " corrente = null;" + NL + "\tprotected boolean loop = false;" + NL + "\t" + NL + "\tprotected String urlCorrente = null;" + NL + "\t" + NL + "\t// Se a pagina estiver com erro de acentos e precisa usar um versao de charset diferente." + NL + "\t// Possibilidades: CallbackParseHtml.HTML4_CHARSET ou CallbackParseHtml.HTML5_CHARSET" + NL + "\t@Override" + NL + "\tpublic String getCharSet() {" + NL + "\t\treturn null;" + NL + "\t}" + NL + "" + NL + "\tprotected String getUrlPrefixo() {" + NL + "\t\treturn \"\";" + NL + "\t}" + NL + "\t" + NL + "\t@Override" + NL + "\tpublic final URL getUrl() throws MalformedURLException {" + NL + "\t\t//if (urlCorrente==null)" + NL + "\t\turlCorrente = dadosParse.getUrlLista();" + NL + "\t\tif (urlCorrente.indexOf(\"http\")==-1)" + NL + "\t\t\tif (urlCorrente.indexOf(0)!='/')" + NL + "\t\t\t\turlCorrente = getUrlPrefixo() + \"/\" + urlCorrente;" + NL + "\t\t\telse" + NL + "\t\t\t\turlCorrente = getUrlPrefixo() + urlCorrente;" + NL + "\t\tURL url = new URL(urlCorrente);" + NL + "\t\treturn url;" + NL + "\t}" + NL + "" + NL + "" + NL + "\t@Override" + NL + "\tpublic final void setDados(IDadosParse paramIDadosParse) {" + NL + "\t\tdadosParse = (";
