...
public class DadosParseBase
{
  ...
  protected final String TEXT_8 = ".log.ArquivoLog;" + NL + "" + NL + "" + NL + "public abstract class ";
  ...
  protected final String TEXT_12 = "> lista = null;" + NL + "\t" + NL + "\tprivate boolean debug;" + NL + "\t" + NL + "\tpublic void setDebug() {" + NL + "\t\tdebug = true;" + NL + "\t}" + NL + "\t" + NL + "\tprivate String proximaPagina = null;" + NL + "\tpublic void setProximaPagina(String url) {" + NL + "\t\tproximaPagina = url;" + NL + "\t}" + NL + "\t" + NL + "\t" + NL + "\t// Para ser utilizado quando se esta obtendo o detalhe " + NL + "\t// do Objeto ";
