...
public class RegraColecaoBase
{
  ...
  protected final String TEXT_80 = NL + "\tpublic void criaRelSeNaoExiste(";
  protected final String TEXT_81 = " item, DaoConexao conexao) throws DaoException {" + NL + "\t\t";
  protected final String TEXT_82 = "Dao dao = getDao(conexao);" + NL + "\t\t";
  protected final String TEXT_83 = " obj = dao.obtemPorRel(item.get";
  protected final String TEXT_84 = "(), item.get";
  protected final String TEXT_85 = "());" + NL + "\t\tif (obj==null) {" + NL + "\t\t\tdao.insereItem(item);" + NL + "\t\t}" + NL + "\t}" + NL + "\t";
  protected final String TEXT_86 = NL + "\t" + NL + "\t// Tratamento de objetos que possuem FK nesse objeto para objetos associativos" + NL + "\t";
  protected final String TEXT_87 = NL + "\t//public List getPor";
  protected final String TEXT_88 = "(long id) throws DaoException{ // Padrao" + NL + "\tpublic List ListaPor";
  protected final String TEXT_89 = "(long id, DaoConexao conexao) throws DaoException{ // Combinar com Interface" + NL + "\t\t";
  protected final String TEXT_90 = "Dao dao = getDao(conexao);" + NL + "\t\tList saida = null;" + NL + "\t\tsaida = dao.ListaPor";
  protected final String TEXT_91 = "(id);" + NL + "\t\treturn saida;" + NL + "\t}" + NL + "\tpublic boolean excluiPor";
  protected final String TEXT_92 = "(long id) throws DaoException{" + NL + "\t\t// Existe no DAO" + NL + "       \treturn true;" + NL + "\t}" + NL + "\t";
