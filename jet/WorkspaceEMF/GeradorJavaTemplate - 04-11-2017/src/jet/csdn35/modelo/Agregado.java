...
public class Agregado
{
  ...
  protected final String TEXT_2 = ".modelo.carregador;" + NL + "" + NL + "" + NL + "" + NL + "namespace ";
  ...
  protected final String TEXT_75 = " " + NL + "\t\t{\t" + NL + "\t\t\tget {" + NL + "\t\t\t\tif (lista";
  protected final String TEXT_76 = " == null) return null;" + NL + "\t\t\t\treturn lista";
  protected final String TEXT_77 = "[lista";
  protected final String TEXT_78 = ".Count-1];" + NL + "\t\t\t}" + NL + "\t\t} " + NL + "\t\tpublic void CriaVaziaLista";
  protected final String TEXT_79 = "_";
  protected final String TEXT_80 = "() {" + NL + "\t\t\tif (lista";
  protected final String TEXT_81 = " == null)" + NL + "            {" + NL + "            \tlista";
  protected final String TEXT_82 = " = new List<";
