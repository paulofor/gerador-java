...
public class MontadorDao
{
  ...
  protected final String TEXT_17 = NL + "\t  objeto.";
  protected final String TEXT_18 = " = resultadoLista.get";
  protected final String TEXT_19 = "(pos++);" + NL + "\t";
  protected final String TEXT_20 = NL + "      return objeto;" + NL + "\t}" + NL + "\tpublic int quantidadeCampos()  {" + NL + "      return ";
...
Configuracao conf = recursos.getConfiguracao();
    ...
    stringBuffer.append( item.getNomePropriedade() );
    stringBuffer.append(TEXT_18);
    stringBuffer.append( item.getTipoFuncaoMontador() );
