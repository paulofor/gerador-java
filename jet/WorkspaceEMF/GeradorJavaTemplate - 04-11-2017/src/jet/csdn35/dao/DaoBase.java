...
public class DaoBase
{
  ...
  protected final String TEXT_9 = NL + "\tpublic ArrayList ObtemPorUsuario(Usuario usuario) {" + NL + " \t\t String sql = \"select \" + camposOrdenados() + \" from \" + tabelaSelect() +" + NL + "                \" where \" + tabelaSelect() + \".id_usuario_s = \" + usuario.IdObj;" + NL + "         return getListaSql(sql);" + NL + " \t}" + NL + " \t";
