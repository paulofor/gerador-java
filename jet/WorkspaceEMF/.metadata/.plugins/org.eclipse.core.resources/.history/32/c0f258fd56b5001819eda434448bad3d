...
public class RegraColecaoBase
{
  protected static String nl;
  public static synchronized RegraColecaoBase create(String lineSeparator)
  {
    nl = lineSeparator;
    RegraColecaoBase result = new RegraColecaoBase();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_2 = ".regracolecao;" + NL + "" + NL + "" + NL + "" + NL + "import java.util.*;" + NL + "import br.com.digicom.lib.*;" + NL + "import br.com.digicom.lib.dao.*;" + NL + "" + NL + "" + NL + "import ";
  ...
  protected final String TEXT_20 = "> dado) {" + NL + "\t\t_listaItem = dado;" + NL + "\t}" + NL + "\tprivate List _listaGenerica;" + NL + "\tprotected List getListaEntradaGenerica() {" + NL + "\t\treturn _listaGenerica;" + NL + "\t}" + NL + "\tpublic void setListaEntradaGenerica(final List dado) {" + NL + "\t\t_listaGenerica = dado;" + NL + "\t}";
  ...
  protected final String TEXT_29 = NL + NL + NL + NL + NL + "\tpublic static final ";
  ...
  protected final String TEXT_78 = "(long id) throws DaoException{" + NL + "\t\t// Existe no DAO" + NL + "       \treturn true;" + NL + "\t}" + NL + "\tpublic List getPor";
  protected final String TEXT_79 = "(long id, DaoConexao conn) throws DaoException {" + NL + "\t\t";
  protected final String TEXT_80 = "Dao dao = getDao(conn);" + NL + "\t\treturn dao.ListaPor";
  protected final String TEXT_81 = "(id);" + NL + "\t}" + NL + "\t";
  protected final String TEXT_82 = NL + "\t" + NL + "\t\t" + NL + "\t";
  protected final String TEXT_83 = NL + "\tpublic void criaRelSeNaoExiste(";
  protected final String TEXT_84 = " item, DaoConexao conexao) throws DaoException {" + NL + "\t\t";
  protected final String TEXT_85 = "Dao dao = getDao(conexao);" + NL + "\t\t";
  protected final String TEXT_86 = " obj = dao.obtemPorRel(item.get";
  protected final String TEXT_87 = "(), item.get";
  protected final String TEXT_88 = "());" + NL + "\t\tif (obj==null) {" + NL + "\t\t\tdao.insereItem(item);" + NL + "\t\t}" + NL + "\t}" + NL + "\t";
  protected final String TEXT_89 = NL + "\t" + NL + "\t// Tratamento de objetos que possuem FK nesse objeto para objetos associativos" + NL + "\t";
  protected final String TEXT_90 = NL + "\t//public List getPor";
  protected final String TEXT_91 = "(long id) throws DaoException{ // Padrao" + NL + "\tpublic List ListaPor";
  protected final String TEXT_92 = "(long id, DaoConexao conexao) throws DaoException{ // Combinar com Interface" + NL + "\t\t";
  protected final String TEXT_93 = "Dao dao = getDao(conexao);" + NL + "\t\tList saida = null;" + NL + "\t\tsaida = dao.ListaPor";
  protected final String TEXT_94 = "(id);" + NL + "\t\treturn saida;" + NL + "\t}" + NL + "\tpublic boolean excluiPor";
  protected final String TEXT_95 = "(long id) throws DaoException{" + NL + "\t\t// Existe no DAO" + NL + "       \treturn true;" + NL + "\t}" + NL + "\t";
