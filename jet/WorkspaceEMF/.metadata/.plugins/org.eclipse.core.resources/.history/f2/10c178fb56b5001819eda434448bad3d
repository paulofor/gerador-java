...
public class FiltroServico
{
  ...
  protected final String TEXT_2 = ".servico.filtro;" + NL + "" + NL + "import java.util.List;" + NL + "import ";
  ...
  protected final String TEXT_28 = NL + NL + "\t\tpublic String getRequest() {" + NL + "\t\t\tString saida = \"\";";
  protected final String TEXT_29 = NL + "\t\t\tif (_";
  protected final String TEXT_30 = "!=null)" + NL + "\t\t\t\tsaida += \"&";
  protected final String TEXT_31 = "=\"+_";
  protected final String TEXT_32 = ";";
  protected final String TEXT_33 = NL + "\t\t\treturn saida;\t" + NL + "\t\t}" + NL + "}";
...
Configuracao conf = recursos.getConfiguracao();
    ...
    stringBuffer.append( ConverteTipoAndroid.getTipoFiltro(filtro.getTipoCampoFiltro()) );
