...
public class FragmentTrataBase
{
  ...
  protected final String TEXT_7 = " item = null;" + NL + "\tprotected ";
  protected final String TEXT_8 = " getItem() {" + NL + "\t\treturn item;" + NL + "\t}" + NL + "\tpublic void setItem(";
  protected final String TEXT_9 = " valor) {" + NL + "\t\titem = valor;" + NL + "\t}" + NL + "" + NL + "\t" + NL + "\tprotected abstract void inicializaCamposTela(View v);" + NL + "\t" + NL + "}";
