...
// PARECE QUE NAO ESTA SENDO UTILIZADO !!!!!
		...
		if (arg1=="OBJ") {
			if (objetoCorrente!=null) {
				...
				if (itemPai!=null) {
					...
					if (objetoCorrente instanceof RelacionamentoI) 
						this.aplicacao.addRelacionamento((RelacionamentoI)objetoCorrente);
					if (objetoCorrente instanceof ClasseViewI) 
						this.aplicacao.addClasseView((ClasseViewI)objetoCorrente);
					objetoCorrente = null;
				}
			}
		}
