package com.br.brasilcap.cap.obl.conferenciasituacao.servlet;
...
public class ConferenciasituacaoCT extends  AbstractServletCT
{
...
{
formBean.setSaida("OblConferenciasituacaoCN.jsp");
return formBean;
}
}
