package com.br.brasilcap.cap.obl.rendparceirovendapessoajuridica.servlet;
...
public class RendparceirovendapessoajuridicaCT extends  AbstractServletCT
{
...
{
formBean.setSaida("OblRendparceirovendapessoajuridicaCN.jsp");
return formBean;
}
}
