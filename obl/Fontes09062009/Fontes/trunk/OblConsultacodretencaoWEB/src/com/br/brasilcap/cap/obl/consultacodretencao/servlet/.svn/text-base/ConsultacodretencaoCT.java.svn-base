package com.br.brasilcap.cap.obl.consultacodretencao.servlet;
...
public class ConsultacodretencaoCT extends  AbstractServletCT
{
...
{
formBean.setSaida("OblConsultacodretencaoCN.jsp");
return formBean;
}
}
