...
<FORM action='controleretornoparceirovendact' name='Executor' target='negocio' method='post'>
...
<input type='hidden' name='prmServico' value='controleretornoparceirovenda'>
