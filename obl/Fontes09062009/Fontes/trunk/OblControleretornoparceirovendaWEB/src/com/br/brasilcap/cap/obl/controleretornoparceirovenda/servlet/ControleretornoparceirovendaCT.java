package com.br.brasilcap.cap.obl.controleretornoparceirovenda.servlet;
...
public class ControleretornoparceirovendaCT extends  AbstractServletCT
{
...
{
formBean.setSaida("OblControleretornoparceirovendaCN.jsp");
return formBean;
}
}
