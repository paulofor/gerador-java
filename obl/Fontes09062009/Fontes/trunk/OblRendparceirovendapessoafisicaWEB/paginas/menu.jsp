...
<FORM action='rendparceirovendapessoafisicact' name='Executor' target='negocio' method='post'>
...
<input type='hidden' name='prmServico' value='rendparceirovendapessoafisica'>
