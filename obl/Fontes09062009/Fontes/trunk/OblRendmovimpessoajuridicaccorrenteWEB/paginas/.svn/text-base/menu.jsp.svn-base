...
<FORM action='rendmovimpessoajuridicaccorrentect' name='Executor' target='negocio' method='post'>
...
<input type='hidden' name='prmServico' value='rendmovimpessoajuridicaccorrente'>
