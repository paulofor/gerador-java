package com.br.brasilcap.cap.obl.rendmovimpessoajuridicaccorrente.servlet;
...
public class RendmovimpessoajuridicaccorrenteCT extends  AbstractServletCT
{
...
{
formBean.setSaida("OblRendmovimpessoajuridicaccorrenteCN.jsp");
return formBean;
}
}
