package com.br.brasilcap.cap.obl.consultarotinas.servlet;
...
public class ConsultarotinasCT extends  AbstractServletCT
{
...
{
formBean.setSaida("OblConsultarotinasCN.jsp");
return formBean;
}
}
