package com.br.brasilcap.cap.obl.rendmovimpessoafisicaccorrente.servlet;
...
public class RendmovimpessoafisicaccorrenteCT extends  AbstractServletCT
{
...
{
formBean.setSaida("OblRendmovimpessoafisicaccorrenteCN.jsp");
return formBean;
}
}
