package com.br.brasilcap.cap.obl.consultaperiodicidades.servlet;
...
public class ConsultaperiodicidadesCT extends  AbstractServletCT
{
...
{
formBean.setSaida("OblConsultaperiodicidadesCN.jsp");
return formBean;
}
}
