package com.br.brasilcap.cap.obl.rendgraficapessoafisica.servlet;
...
public class RendgraficapessoafisicaCT extends  AbstractServletCT
{
...
{
formBean.setSaida("OblRendgraficapessoafisicaCN.jsp");
return formBean;
}
}
