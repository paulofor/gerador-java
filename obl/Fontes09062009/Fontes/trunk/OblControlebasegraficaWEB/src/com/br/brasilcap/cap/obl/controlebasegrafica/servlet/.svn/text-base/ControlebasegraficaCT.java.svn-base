package com.br.brasilcap.cap.obl.controlebasegrafica.servlet;
...
public class ControlebasegraficaCT extends  AbstractServletCT
{
...
{
formBean.setSaida("OblControlebasegraficaCN.jsp");
return formBean;
}
}
