package com.br.brasilcap.cap.obl.solicitacaosegundavia.servlet;
...
public class SolicitacaosegundaviaCT extends  AbstractServletCT
{
...
{
formBean.setSaida("OblSolicitacaosegundaviaCN.jsp");
return formBean;
}
}
